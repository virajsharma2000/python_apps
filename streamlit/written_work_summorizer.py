...
def summorize_school_written_work(text):
  ...
  questions_and_answers = requests.post('https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key=AIzaSyAIOM_Lav2P6Ip1BgZ8IgryqDIDDF1QeNY', json = myobj) 
