...
def flip(event):
    ...
    head_and_tails = ['head','tails','head','tails','head','tails','head','tails','head','tails']

    head_or_tails = random.choice(head_and_tails)

    if player1_choice == player2_choice:
        popup = Popup(title = 'coinflip',content = Label(text = 'Error - player1 and player2 both cannot choose one thing'),size_hint = (.1000,.200))
